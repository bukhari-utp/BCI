...
def feature_extraction(state):
    ...
    while (i+255)<1280:
        ...
        # Up state
        if state==1:
            OUTPUT_DATASET.append([1,0,0,0,0])
        # Right state
        elif state==2:
            OUTPUT_DATASET.append([0,1,0,0,0])
        # Down state
        elif state==3:
            OUTPUT_DATASET.append([0,0,1,0,0])
        # Left state
        elif state==4:
            OUTPUT_DATASET.append([0,0,0,1,0])
        # Neutral state
        elif state==5:
            OUTPUT_DATASET.append([0,0,0,0,1])            

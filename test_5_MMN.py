...
while acc<64:
    ...
    for looper in range(1, 2):
        ...
        while(1):
            ...
            test = NN_UP.foward(init.INPUT_DATASETs)
            test_test = NN_UP.foward(INPUT_DATASETs_test)
    ...
    up_ave = up_ave/1.0
    right_ave = right_ave/1.0
    left_ave = left_ave/1.0
    down_ave = down_ave/1.0
    average_ave = average_ave/1.0
    ...
    up_ave_test = up_ave_test/1.0
    right_ave_test = right_ave_test/1.0
    left_ave_test = left_ave_test/1.0
    down_ave_test = down_ave_test/1.0
    average_ave_test = average_ave_test/1.0
    ...
    time_ave = time_ave/1.0 + endTime - startTime
    numt_ave = numt_ave/1.0
